...
wrap.innerHTML='<div class="wt-card"><div class="wt-title">Последние тесты воды</div><div class="wt-gridcards" id="wtGrid"></div></div><div class="wt-card" id="wtGraphCard"><div style="display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:10px">
cv.appendChild(wrap);
